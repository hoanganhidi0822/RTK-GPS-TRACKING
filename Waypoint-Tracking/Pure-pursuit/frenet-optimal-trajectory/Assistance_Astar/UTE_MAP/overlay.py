...
filename2 = 'MAP_THUAN\HD_MAP2.txt'  # Second file with waypoints
filename3 = 'MAP_NGHICH\HD_MAP1.txt'  # Third file with waypoints
filename4 = 'MAP_NGHICH\HD_MAP2.txt'  # Third file with waypoints
