...
input_file = 'MAP_test.txt'  # Change this to your input file path
output_file = 'output_xyMAP.py'  # Save results as a Python script

wx = []  # List to store x values
wy = []  # List to store y values
...
# Write the result as Python code
